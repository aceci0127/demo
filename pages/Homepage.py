...
with col_title:
    st.markdown('<h1 class="header-title">A T H E N A - Vetrina Demo</h1> <h2>Esplora l\'avanguardia della conoscenza attraverso le conversazioni</h2>', unsafe_allow_html=True)
